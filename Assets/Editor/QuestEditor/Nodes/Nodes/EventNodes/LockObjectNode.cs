...
{
    public class LockObjectNode : EventNode
    {
        ...
        public static LockObjectNode Create(Vector2 position)
        {
            LockObjectNode temp = new LockObjectNode();
            temp.GUID = "LockObjectNode" + ActionCount;
            ...
            temp._activate = new Toggle("Lock");
        ...
        public static LockObjectNode LoadNode(JSONNode data)
        {
            LockObjectNode temp = new LockObjectNode();
