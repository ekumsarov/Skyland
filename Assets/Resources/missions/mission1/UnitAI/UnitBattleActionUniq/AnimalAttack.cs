...
{
    public class AnimalAttack : BattleAction
    {
        public override void PrepareBattleAction()
        {
            this.ID = "AnimalAttack";
            ...
            if (IOM.BattleActionInfoDic.ContainsKey(this.ID))
            {
                ...
                {
                    this.SuccessCheck.AddSkill(SkillCheckObject.Create("strenght", 4));
                }
                ...
                {
                    this.AvoidCheck.AddSkill(SkillCheckObject.Create("stamina", 5));
                }
            }
            else
            {
