...
public class UIContainer : UIeX
{
    ...
    public override void Setting()
    {
        ...
        this.simplesTexts = new List<SimpleText>();
        this.iconsTexts = new List<UIIconText>();
        this.imagess = new List<UIImage>();
        this._containers = new List<UIContainer>();

        this._itemStore._parent = this;
